...
public class DrawerPullConfigurationView extends ConfigurationView {
	...
	public boolean save() throws Exception {
		...
		JOptionPane.showMessageDialog(this, com.floreantpos.POSConstants.Restart_Auto_Drawer_Pull_Config_Msg);
		return true;
	}
	...
	public String getName() {
		return com.floreantpos.POSConstants.Auto_Drawer_Pull_Config;
	}
}
