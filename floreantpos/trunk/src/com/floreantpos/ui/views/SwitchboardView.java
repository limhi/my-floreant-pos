...
import com.floreantpos.ui.dialog.PicTakingDialog;
...
public class SwitchboardView extends JPanel implements ActionListener {
	...
	public SwitchboardView() {
		...
		//luke 20120117
		btnOtherFunctions.addActionListener(this);
		
		//luke 20120130 start
		btnNewCustomer.addActionListener(this);
		btnEditCustomer.addActionListener(this);
		btnPrintCustomer.addActionListener(this);
		btnOtherFunctionsCustomer.addActionListener(this);
		//luke 20120130 end
		//luke 20120131
	...
	private void initComponents() {
		...
		//gush very bad design 2012/02/21
		 ChangeListener changeListener = new ChangeListener() {
		      public void stateChanged(ChangeEvent changeEvent) {
		        JTabbedPane sourceTabbedPane = (JTabbedPane) changeEvent.getSource();
		        int index = sourceTabbedPane.getSelectedIndex();
		        logger.debug("Tab changed to: " + sourceTabbedPane.getTitleAt(index));
		        JPanel panel= (JPanel) sourceTabbedPane.getComponent(index);
		        logger.debug(panel.getComponentCount());
		        TicketListView ticketListView=(TicketListView) panel.getComponent(0);
		        logger.debug(ticketListView.getTable().getModel().getRowCount());
		        int size=ticketListView.getTable().getModel().getRowCount();
		        User user=Application.getCurrentUser();
		        if(user!=null){
		        	lblUserName.setText(POSConstants.WELCOME + " " + user.toString()+ " " + POSConstants.YOU + " " + POSConstants.HAVE + " " + size + " " + POSConstants.OPEN.toLowerCase() + " " + POSConstants.TICKETS);
		        }
		...
		javax.swing.JPanel customerBtnPanel = new javax.swing.JPanel();

		btnNewCustomer = new com.floreantpos.swing.PosButton();
		btnEditCustomer = new com.floreantpos.swing.PosButton();
		btnPrintCustomer = new com.floreantpos.swing.PosButton();
		btnOtherFunctionsCustomer = new com.floreantpos.swing.PosButton();
		//luke 20120130 end
		// luke 20120131
		...
		TicketListView.ShrimpTicketListTableModel model=openTicketList.new ShrimpTicketListTableModel();
		shrimpTicketList = new com.floreantpos.ui.TicketListView(model);
		...
		//luke 20120117
		btnOtherFunctions = new com.floreantpos.swing.PosButton();
		...
		//luke 20120130 start
		customerPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, POSConstants.CUSTOMERSLIST, javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
		customerPanel.setLayout(new java.awt.BorderLayout(5, 5));
		
		// 在此加入想要實作的顧客清單，目前提供一個空的panel
		// table寫法可以參考com.floreantpos.ui.TicketListView
		customerPanel.add( shrimpTicketList, java.awt.BorderLayout.CENTER);
		
		customerBtnPanel.setPreferredSize(new java.awt.Dimension(655, 160));
		customerBtnPanel.setLayout(new java.awt.GridLayout(3, 0, 5, 5));		
		//luke 20120130 end
		...
		//luke 20120117 start
		//btnOtherFunctions.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/print_32.png")));
		//need to be localized
		btnOtherFunctions.setText("隱藏其他功能");
		btnOtherFunctions.setPreferredSize(new java.awt.Dimension(120, 50));
		activityPanel.add(btnOtherFunctions);
		isShowOtherFunctions = true;
		
		//luke 20120117 end

		//luke 20120130 start 
		
		btnNewCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/new_ticket_32.png")));
		btnNewCustomer.setText(POSConstants.CAPITAL_NEW);
		btnNewCustomer.setPreferredSize(new java.awt.Dimension(120, 50));
		customerBtnPanel.add(btnNewCustomer);

		btnEditCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/edit_ticket_32.png")));
		btnEditCustomer.setText(POSConstants.LEAVE);
		btnEditCustomer.setPreferredSize(new java.awt.Dimension(120, 50));
		customerBtnPanel.add(btnEditCustomer);

		btnPrintCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/print_32.png")));
		btnPrintCustomer.setText(POSConstants.CAPITAL_PRINT);
		btnPrintCustomer.setPreferredSize(new java.awt.Dimension(120, 50));
		customerBtnPanel.add(btnPrintCustomer);
		
		btnOtherFunctionsCustomer.setText("隱藏其他功能");
		btnOtherFunctionsCustomer.setPreferredSize(new java.awt.Dimension(120, 50));
		customerBtnPanel.add(btnOtherFunctionsCustomer);
		// luke 20120131 start
		// need to be localized
		
		// luke 20120131 end
		
		customerPanel.add(customerBtnPanel, java.awt.BorderLayout.SOUTH);
		//luke 20120130 end 
		
		bottomLeftPanel.add(activityPanel, java.awt.BorderLayout.SOUTH);

		// luke 20120130 start
		tabbedPanel.add( POSConstants.OPEN_TICKETS_AND_ACTIVITY, bottomLeftPanel);
		tabbedPanel.add( POSConstants.CUSTOMERSLIST, customerPanel);
		// bottomPanel.add(bottomLeftPanel, java.awt.BorderLayout.CENTER);
		bottomPanel.add( tabbedPanel, java.awt.BorderLayout.CENTER);
		// luke 20120130 end
		...
		//20120129 luke start
		//將主畫面的「支出」按鈕移至「Others」的「主管功能」上方
		org.jdesktop.layout.GroupLayout bottomRightPanelLayout = new org.jdesktop.layout.GroupLayout(
		    bottomRightPanel);
		bottomRightPanel.setLayout( bottomRightPanelLayout);
		bottomRightPanelLayout
		    .setHorizontalGroup( bottomRightPanelLayout.createParallelGroup(
		...
		bottomRightPanelLayout.setVerticalGroup( bottomRightPanelLayout
	...
	private void createNewTicket() {
		...
		if (ticket != null) {
			//20120206 gush please internationlize msg
			...
			if (option == JOptionPane.YES_OPTION) {
				...
				//gush 20120206 create ticket again
				createNewTicket();
				return;
	...
	//luke 20120117
	private void doOtherFunctions() {
		logger.debug("doOtherFunctions");
		if(isShowOtherFunctions){
			isShowOtherFunctions=false;
			btnOtherFunctions.setText("顯示其他功能");		
			btnOtherFunctionsCustomer.setText("顯示其他功能");		
		...
		bottomRightPanel.setVisible(isShowOtherFunctions);		
	}

	private void doEditCustomer() {
		Ticket ticket = shrimpTicketList.getSelectedTicket();
		if (ticket == null) {
			POSMessageDialog.showMessage(POSConstants.SELECT_A_TICKET_FROM_THE_OPEN_TICKET_LIST);
			return;
		}
		ticket.setLeave(true);
		TicketDAO.getInstance().update(ticket);
		updateView();
		
	}
	private void doPrintCustomer() {}
	private void doOtherFunctionsCustomer() {
		logger.debug("doOtherFunctionsCustomer");
		doOtherFunctions();		
	}
	// luke 20120130 end
	//luke 20120131 start
	private void doTimeSetup(){
		logger.debug("doTimeSetup");		
	...
	private void updateTicketList() {
		...
		openTickets=dao.findShrimpTickets();
		shrimpTicketList.setTickets(openTickets);
		//gush 2012/02/21  把時間到期的人 變成紅色
...
//		lblUserName.setText(POSConstants.WELCOME + " " + user.toString() + ". " + POSConstants.YOU + " " + POSConstants.HAVE + " " + openTickets.size() + " " + POSConstants.OPEN.toLowerCase() + " " + POSConstants.TICKETS);
	...
	private com.floreantpos.ui.TicketListView shrimpTicketList;
	
	//luke 20120117
	private com.floreantpos.swing.PosButton btnOtherFunctions;
	
	//luke 20120130 start 
	private com.floreantpos.swing.PosButton btnNewCustomer;
	private com.floreantpos.swing.PosButton btnEditCustomer;
	private com.floreantpos.swing.PosButton btnPrintCustomer;
	private com.floreantpos.swing.PosButton btnOtherFunctionsCustomer;
	//luke 20120130 end
	// luke 20120131
	...
	//is bottomRightPanel showen?
	private boolean isShowOtherFunctions;
	...
	public void actionPerformed(ActionEvent e) {
		...
		//luke 20120117
		if (source == btnOtherFunctions) {
			doOtherFunctions();
		}
	
		if (source == btnEditCustomer) {
			doEditCustomer();
		}
		if (source == btnPrintCustomer) {
			doPrintCustomer();
		}
		if (source == btnOtherFunctionsCustomer) {
			doOtherFunctionsCustomer();
		}
		//luke 20120130 end
		
		
		//gush 20120206 start
		if (source == btnNewCustomer) {
			doCreateNewCustomer();
		}
	}
	...
	private void doCreateNewCustomer() {
		...
		//take a pic 
		PicTakingDialog dialog = new PicTakingDialog();
		dialog.setTitle(POSConstants.TAKE_A_PICTURE);
		dialog.pack();
		dialog.open(); 
		...
		ticket.setNumberOfGuests(0);
		ticket.setTerminal(application.getTerminal());
		ticket.setOwner(Application.getCurrentUser());
		ticket.setShift(application.getCurrentShift());
		ticket.setLeave(false);
		ticket.setPhotoPath(dialog.getPhotoPath());
		Calendar currentTime = Calendar.getInstance();
		ticket.setCreateDate(currentTime.getTime());
		ticket.setCreationHour(currentTime.get(Calendar.HOUR_OF_DAY));
