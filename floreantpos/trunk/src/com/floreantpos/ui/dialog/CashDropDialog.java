...
public class CashDropDialog extends POSDialog {
	...
	public CashDropDialog(Frame parent) {
		...
		TitledBorder titledBorder = new TitledBorder(terminal.getName() + " " +com.floreantpos.POSConstants.NEW_DRAWER_EVENT);
		...
		setTitle(com.floreantpos.POSConstants.DRAWER_BLEED);
	}
...
//        titlePanel1.setTitle("REMOVE CASH FROM DRAWER");
        titlePanel1.setTitle(com.floreantpos.POSConstants.REMOVE_CASH_FROM_DRAWER);
        ...
        btnNewCashDrop.setText(com.floreantpos.POSConstants.NEW_DRAWER_BLEED);
        ...
        btnDeleteSelected.setText(com.floreantpos.POSConstants.DELETE_SELECTED);
        ...
        lblActiveCashDrop.setText(com.floreantpos.POSConstants.NEW_DRAWER_EVENT);
	...
	private void btnDeleteSelectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteSelectedActionPerformed
		try {
			...
			POSMessageDialog.showError(com.floreantpos.POSConstants.DELETING_CASH_DROP_ERROR, e);
		}
	...
	private void btnNewCashDropActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewCashDropActionPerformed
		try {
			...
			dialog.setTitle(com.floreantpos.POSConstants.DRAWER_BLEED_AMOUNT);
			...
			POSMessageDialog.showError(com.floreantpos.POSConstants.SAVING_CASH_DROP_ERROR, e);
		}
