...
@XmlRootElement(name = "EventMeterRequest")
public class EventMeterRequest {

    @XmlElement(name = "MNum", namespace = "http://www.gama.com/TableWS")
    protected int mNum;
    @XmlElement(name = "EventId", namespace = "http://www.gama.com/TableWS")
    protected int eventId;
    @XmlElement(name = "EventTime", namespace = "http://www.gama.com/TableWS", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar eventTime;
    @XmlElement(name = "BillIn", namespace = "http://www.gama.com/TableWS")
    protected double billIn;
    @XmlElement(name = "Note1", namespace = "http://www.gama.com/TableWS")
    protected int note1;
    @XmlElement(name = "Note2", namespace = "http://www.gama.com/TableWS")
    protected int note2;
    @XmlElement(name = "Note3", namespace = "http://www.gama.com/TableWS")
    protected int note3;
    @XmlElement(name = "Note4", namespace = "http://www.gama.com/TableWS")
    protected int note4;
