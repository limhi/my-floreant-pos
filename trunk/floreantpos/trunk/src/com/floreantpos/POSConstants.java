...
public class POSConstants {
	...
	//luke 20120130
	public static final String CUSTOMERSLIST = Messages.getString("Switchboard.37"); //$NON-NLS-1$
	...
	//Candice
	public static final String REMOVE_CASH_FROM_DRAWER = Messages.getString("PosMessage.1000");
	public static final String RESET_DRAWER = Messages.getString("PosMessage.1001");
	public static final String TRANSFER_SERVER = Messages.getString("PosMessage.1002");
	public static final String NEW_DRAWER_BLEED = Messages.getString("PosMessage.1003");
	public static final String DELETE_SELECTED = Messages.getString("PosMessage.1004");
	public static final String NEW_DRAWER_EVENT = Messages.getString("PosMessage.1005");
	public static final String DELETING_CASH_DROP_ERROR = Messages.getString("PosMessage.1006");
	public static final String DRAWER_BLEED_AMOUNT = Messages.getString("PosMessage.1007");
	public static final String SAVING_CASH_DROP_ERROR = Messages.getString("PosMessage.1008");
	//20120206 GUSH 
	public static final String TAKE_A_PICTURE = Messages.getString("PosMessage.1009");
	public static final String LEAVE = Messages.getString("PosMessage.1010");
	//20120226 Candice
	public static final String Auto_Drawer_Pull_Config = Messages.getString("PosMessage.1011");
	public static final String Restart_Auto_Drawer_Pull_Config_Msg = Messages.getString("PosMessage.1012");
	public static final String Kitchen_Printer = Messages.getString("PosMessage.1013");
